...
public class EventListener implements Listener
{
	...
	{	
		...
		boolean restrictedItem = ( itemInHand.compareTo( Material.FLINT_AND_STEEL ) == 0 || 
		            ...
		            itemInHand.compareTo( Material.HOPPER ) == 0 || 
	                itemInHand.compareTo( Material.HOPPER_MINECART ) == 0;
		...
		if ( isProtected )
		{
            ...
            if (!containers) {
                ...
                if ( blocktype == Material.CHEST || 
                        ...
                        blocktype == Material.STORAGE_MINECART
                        )
                {
                        ...
                        e.setCancelled( true );
                        return;
                } else if (blocktype == Material.HOPPER || 
